...
use LogistiqueBundle\Entity\abonnement;
...
class abonnementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $abonnements = $em->getRepository('LogistiqueBundle:abonnement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('LogistiqueBundle\Form\abonnementType', $abonnement);
    ...
    {
        $deleteForm = $this->createDeleteForm($abonnement);
        $editForm = $this->createForm('LogistiqueBundle\Form\abonnementType', $abonnement);
